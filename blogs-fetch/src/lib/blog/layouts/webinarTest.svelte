<script>
	...
	let tracks = blog['video_playlist_id']['videos'];
	...
	<div class="container">
		 <div class="blog-hero">
			...
			<div class="author-details">
				<img src={`/assets/images/coaches/${authorSlug}.png`} alt="Coach Thumbnail" class="coach-thumbnail"/>
				<div>
		...
		<div class="video-content">
			<div class="video-holder">
				<div class="video">
					<video class="mux-video" bind:this={videoPlayer} id="player" poster="https://image.mux.com/{tracks[currentTrack]['video_id']['mux_playback_id']}/thumbnail.png?time={thumbnailSeconds}" crossorigin autoplay playsinline controls >
						<source src="https://stream.mux.com/{tracks[currentTrack]['video_id']['mux_playback_id']}.m3u8" type="video/mp4" />
					</video>
				</div>

				<div class="lesson-description">
					{@html tracks[currentTrack]['video_id']['description']}
				</div>
			...
			<div class="course-details">
				...
				<div class="column">
					...
					<ul class="chapters-list">
						{#each tracks as track, _index}
							<li class="chapter" on:click={(event) => changeTrack(_index)}>
								<img src={`https://image.mux.com/${track['video_id']['mux_playback_id']}/thumbnail.png?time=${thumbnailSeconds}`} alt="Chapter Image" />
								<h4 class="headline sm">{title}</h4>
							</li>
						{/each}
